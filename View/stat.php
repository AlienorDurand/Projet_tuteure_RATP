...
<head lang="fr">
        ...
        function drawChart() {
            ...
            data.addRows([
                ['Trajets effectués', <?php var_dump($nbTrajetsEffectues) ;?>],
                ['Passages par votre station préférée', <?php var_dump($nbTrajetsStation1) ;?>],
                ['Passages par votre 2e station préférée', <?php var_dump($nbTrajetsStation2) ;?>]
            ]);
...
<body>
	...
	<p><a href="membre.php">Retour à la page membre</a></p>
